...
public class SkiaImageDecoder implements ImageDecoder {
    ...
    public Bitmap decode(Context context, @NonNull Uri uri) throws Exception {
        ...
        return decodeWithOptions(context, uri, options);
    }

    @Override
    @NonNull
    public Bitmap decodeWithOptions(Context context, @NonNull Uri uri, BitmapFactory.Options options) throws Exception {
