...
/**
 * While changing size of {@link com.davemorrissey.labs.subscaleview.SubsamplingScaleImageView}, change scale and center for smooth transition.
 * <p>This transition must be postponed, because it will fail if image is not loaded.</p>
 */
public class SubsamplingScaleImageViewSharedTransition extends Transition {
    private static final String PROPNAME_STATE = "com.example.simpleimageviewer:transition:state";
    private static final String PROPNAME_SIZE = "com.example.simpleimageviewer:transition:size";
    private static final String PROPNAME_CENTER_X = "com.example.simpleimageviewer:transition:center_x";
    private static final String PROPNAME_CENTER_Y = "com.example.simpleimageviewer:transition:center_y";
    ...
    public SubsamplingScaleImageViewSharedTransition() {
        imageViewScaleType = CENTER_CROP;
        direction = 0;
...
//                    subsamplingScaleType == FIT_CENTER);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                PointF newCenter = new PointF((float) animation.getAnimatedValue(PROPNAME_CENTER_X), (float) animation.getAnimatedValue(PROPNAME_CENTER_Y));
